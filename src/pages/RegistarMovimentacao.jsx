...
export default function RegistarMovimentacao() {
  ...
  const handleSubmit = async (event) => {
    ...
    const formData = {
      idMovimentacoes: form[0].value, // corrigido para pegar o valor do input de data
      idMaquinaMovimentada: form[1].value,
      tipo: form[2].value,
      origem: form[3].value,
      destino: form[4].value,
    };

    try {
      await axios.post("http://localhost:8081/movimentacoes", formData);
